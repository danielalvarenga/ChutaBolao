		...
		<div id="boxMenu">
			<div id="ts_tabmenu">
		        <ul>
					...
					<li id="li_tsmenu3"><a href="index-teste.php?conteudo=classificacao" title="Classificação"><strong>Classifica&ccedil;&atilde;o<img style="border: 0px; width: 25px;" src="imagens/novo.gif"></strong></a></li>
