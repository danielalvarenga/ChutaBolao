...
?>	
	...
	<div id="mural">
		...
		<div class="muralTrofeus">
			...
			<span class="muralQtd"><?php echo $pontuacaoGeral->getTrofeus();?> trof�us conquistados</span>
		</div>
	...
	$conn->rollback();
	?>
	<p class="aviso">Estamos atualizando. Volte amanh� para conferir a novidade.</p>
	<?php 
}
$conn->close();
?>
...
<div id="menuCampeonatos">
		<h3 class="titulo">D� seus Chutes</h3>
		<?php
